...
public class Main {
    final static File databaseFolder = new File("C:\\Users\\B3Y\\IdeaProjects\\Cmp3005\\database");//Give main_doc.txt path here
    final static File controlFolder = new File("C:\\Users\\B3Y\\IdeaProjects\\Cmp3005\\control");//Give controlFolder path here
